...
class Disciplina(models.Model):
    ...
    precondCurr = models.CharField(max_length=300, null=True, default=" ")
    precondCom = models.CharField(max_length=300, null=True, default=" ")
    condDesCurs = models.CharField(max_length=300, null=True, default=" ")
    condDesLab = models.CharField(max_length=300, null=True, default=" ")
    comProf = models.CharField(max_length=300, null=True, default=" ")
    comTrans = models.CharField(max_length=300, null=True, default=" ")
    obiecGeneral = models.CharField(max_length=300, null=True, default=" ")
    obiecSpeci = models.CharField(max_length=300, null=True, default=" ")
    ...
    metpredcurs = models.CharField(max_length=300, null=True, default=" ")
    ...
    metpredlab = models.CharField(max_length=300, null=True, default=" ")
